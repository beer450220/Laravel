    ...
    <div class="card shadow mb-4">
      ...
      @endif
        ...
        <div class="col-md-2">
          ...
          <input type="text" class="form-control" @error('score') is-invalid @enderror name="name" value="{{ old('name') }}"  autofocus placeholder="score" placeholder="Last name" aria-label="Last name">
