    ...
    <div class="card shadow mb-4">
      ...
      @endif
          ...
          <div class="form-group col-md-4">
            ...
            <select class="form-control select2" id="validationSelect1" name="{{$supervisions->establishment_id}}" required>
        ...
        @enderror
          ...
          <div class="col-md-4">
            ...
            <select class="form-control select2" id="validationSelect2" name="student_id" >
        ...
        @enderror
          ...
          <div class="row">
          <div class=" col-md-4">
            <label for="recipient-name" class="col-form-label">ไฟล์เอกสารประเมิน (สก.12)</label>
...
@for ($i = $endYear; $i >= $startYear; $i--)
    @for ($j = 1; $j <= 1; $j++)
        <option value="{{ $i }}-{{ $j }}"@if($supervisions->year==$supervisions->year) selected @endif>{{ $i }}</option>
    @endfor
@endfor
</select>
