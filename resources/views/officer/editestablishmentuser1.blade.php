            ...
            <div class="modal-dialog modal-xl" role="document">
              <div class="modal-content ">
                  ...
                  <form method="POST" action="{{url('/officer/update/'.$establishments->id)}}" enctype="multipart/form-data">
                    ...
                    @enderror
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" class="form-control"	name="address" value="{{$establishments->address}}" placeholder="Last name" aria-label="Last name">
                      </div>
                      <div class="col-md-4">
                        <label for="recipient-name" class="col-form-label">เบอร์โทร</label>
                        <input type="text" class="form-control" name="phone"value="{{$establishments->phone}}" placeholder="Last name" aria-label="Last name">
                      </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        ...
                        <img src="/image/{{ $establishments->images }}" class="img-responsive" style="max-height: 300px; max-width: 200px;" alt="" srcset="">
                        @error('images')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="modal-footer">
                  ...
                  <a href="/officer/establishmentuser1"  class="btn mb-2 btn-secondary" data-dismiss="modal">ยกเลิก</a>
