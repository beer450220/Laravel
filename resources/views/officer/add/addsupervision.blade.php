  ...
  <div class="col-md-12">
    <div class="card shadow mb-4">
      ...
      @endif
       ...
       <input type="text" class="form-control" @error('title') is-invalid @enderror name="title" value="{{ old('title') }}"  autofocus placeholder="title">
...
@endfor
 ...
 <div class="col-md-2">
  ...
  <input class="form-control" id="example-date" type="datetime-local" name="start">
...
<div class="col-md-2"> 
  ...
  <input class="form-control" id="example-date" type="datetime-local" name="end">
